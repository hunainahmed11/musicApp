...
export default function Navbar() {
  const Menus=[
    {title : <Link href="#">Home</Link>, icon: <FaHome/>  },
    {title : <Link href="#">Create Revohloo</Link> ,icon : <FaPlay /> },
    {title : <Link href="#">Hot & New!</Link> ,icon : <FaFire />},
    {title : <Link href="#">Revohloo Videos</Link>,icon : <FaPhotoVideo />},
    {title : <Link href="#">Artists</Link>,icon : <FaMicrophone />},
    {title : <Link href="#">About Us</Link> ,icon : <FaInfoCircle />},
  ];
  const Settings=[
    {title : <Link href="#">FAQ's</Link>,icon : <FaSms />},
    {title : <Link href="#">Help Center</Link> ,icon : <FaHeadphonesAlt /> },
    {title : <Link href="#">Terms Of Us</Link> ,icon : <FaRegFileExcel />},
    {title : <Link href="#">Privacy Policy</Link> ,icon : <FaPhotoVideo />},
    {title : <Link href="#">log Out</Link>,icon : <FaPowerOff />},
  ]
